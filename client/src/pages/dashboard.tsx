      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card data-testid="card-total-employees">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-muted-foreground text-sm">员工总数</p>
                {statsLoading ? (
                  <Skeleton className="h-8 w-16 mt-2" />
                ) : (
                  <p className="text-2xl font-semibold text-foreground" data-testid="text-total-employees">
            ...
            <div className="flex items-center mt-4">
              <span className="text-muted-foreground text-sm">已注册员工</span>
            </div>
          </CardContent>
        </Card>
